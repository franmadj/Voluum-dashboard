                                    ...
                                    <div class="px-4 py-5 bg-white sm:p-6">
                                        <div class="grid grid-cols-6 gap-6">
                                            ...
                                            <div class="col-span-12">
                                                ...
                                                <input required="" name="name"  value="{{ $account->name }}" autocomplete="off"
                                            ...
                                            <div class="col-span-12">
                                                ...
                                                <input required="" name="access_key_id" value="{{ $account->access_key_id }}" autocomplete="off"
                                            ...
                                            <div class="col-span-12">
                                                ...
                                                <input required="" name="access_key" value="{{ $account->access_key }}" autocomplete="off"
                                            ...
                                            <div class="col-span-12">
                                                ...
                                                <div class="rounded-md shadow-sm">
                                                    <textarea name="workspaces" rows="3"
                                                              class="@error('workspaces') is-invalid @enderror form-textarea mt-1 block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5">{{ $account->workspaces }}</textarea>
                                                </div>
                                                @error('workspaces')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
